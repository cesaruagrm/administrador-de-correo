 ...
 * @author YANDIRA SFC
 */
public class modificarUsuario implements AccionCorreo{
    ...
    public String getHtml(List<String> datos) {
        ...
        try {
           ...
           String query = "UPDATE usuario set "
                ...
                + "ci=" + datos.get(2) + ","
                + "sexo='" + datos.get(3)+"',"
                + "direccion='" + datos.get(4) +"',"
                + "pass='" + datos.get(5) +"'"
                + "  WHERE id = '" + datos.get(0) + "';";
            Statement consulta;
            ...
            consulta.close();
                 html += "<li>Se ha Modificado los datos del usuario "+" "+datos.get(1)+" </li>\n";
