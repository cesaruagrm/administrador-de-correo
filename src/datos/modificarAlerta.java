 ...
 * @author CARLOS
 */
public class modificarAlerta implements AccionCorreo{
    ...
    public String getHtml(List<String> datos) {
        ...
        try {
           ...
           String query = "UPDATE alerta set "
                + "diaVence=" + datos.get(1) + ","
                + "descripcion='" + datos.get(2) + "'"
                + "  WHERE id = " + datos.get(0) + " and 'adm' in (select nombre from usuario where pass ='" +datos.get(3) + "' );";
            ...
            consulta.close();
                 html += "<li>Se ha Modificado la Alerta"+" "+datos.get(1)+" </li>\n";
