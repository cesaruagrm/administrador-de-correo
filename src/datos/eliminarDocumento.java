 ...
 * @author CARLOS
 */
public class eliminarDocumento implements AccionCorreo{
    ...
    public String getHtml(List<String> datos) {
        ...
        try {
           ...
           String query = "delete from  documento  where id = " + datos.get(0) +"and 'adm' in (select nombre from usuario where pass ='" +datos.get(1) + "' );";
            Statement consulta;
            ...
            consulta.close();
                 html += "<li>Se ha Eliminado Documento: </li>\n";
