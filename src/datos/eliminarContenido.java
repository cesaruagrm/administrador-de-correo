 ...
 * @author CARLOS
 */
public class eliminarContenido  implements AccionCorreo{
    ...
    public String getHtml(List<String> datos) {
        ...
        try {
           ...
           String query = "delete from  contenido  where id = " + datos.get(0) +"and 'adm' in (select nombre from usuario where pass ='" +datos.get(1) + "' );";
            Statement consulta;
            ...
            consulta.close();
                 html += "<li>Se ha Eliminado Contenido: </li>\n";
